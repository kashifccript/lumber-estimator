      ...
      <SheetContent side='left' className='w-80 p-0'>
        <div className='flex flex-col space-y-2 p-6'>
          ...
          {navItems.map((item) => {
            ...
            const isQuotationsItem =
              item.href === '/dashboard/contractor/quotations';
            const isQuotationDetails = pathname.startsWith(
              '/dashboard/contractor/quotation-details'
            );
            const finalIsActive =
              isActive || (isQuotationsItem && isQuotationDetails);
