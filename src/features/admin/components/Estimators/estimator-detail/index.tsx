...
type TabType = 'profile' | 'estimates';
interface EstimatorInfoProps {
  id?: string;
}
export default function EstimatorInfo({ id }: EstimatorInfoProps) {
    ...
    <div className='w-full'>
      ...
      <div className='mt-8'>
        {activeTab === 'profile' && (
         ...
         {activeTab === 'estimates' && (
          <div className='space-y-6'>
            <EstimatesList status={selectedStatus} user_id={id} />
          </div>
        )}
      </div>
    </div>
