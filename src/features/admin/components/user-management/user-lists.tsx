    ...
    <div>
      <div className='flex flex-row justify-between py-4'>
        <div className='text-[24px] font-semibold text-[#1F1F1F]'>
          All Users <span className='font-normal text-[#1F1F1FCC]'>(24)</span>
        </div>
        ...
        <div className='flex flex-row gap-4'>
          <div className='relative w-full max-w-sm'>
            ...
            <Input
              ...
              className='rounded-[8px] border border-[#8896AB33] py-2 pr-4 pl-10 focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-[#292D32] h-[48px]'
            />
          </div>
          <CustomDropdown
